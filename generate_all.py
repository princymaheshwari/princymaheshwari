...
def generate_footer_svg():
  ...
  <g clip-path="url(#fClip)">
    ...
    <text x="20" y="38" font-family="JetBrains Mono,Fira Code,monospace" font-size="10">
      <tspan fill="#64748b">&#9654; </tspan><tspan fill="#f59e0b">linkedin</tspan><tspan fill="#475569"> &#183; </tspan><tspan fill="#f59e0b">email</tspan><tspan fill="#475569"> &#183; </tspan><tspan fill="#f59e0b">portfolio</tspan>
    </text>
    <rect x="200" y="28" width="7" height="14" fill="#10b981" opacity="0.8">
