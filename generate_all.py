...
def generate_footer_svg():
  ...
  <g clip-path="url(#fClip)">
    ...
    <text x="20" y="38" font-family="JetBrains Mono,Fira Code,monospace" font-size="10">
      ...
      <a href="https://www.linkedin.com/in/princy-maheshwari1/" target="_blank" rel="noopener noreferrer">
        <tspan fill="#f59e0b">linkedin</tspan>
      </a>
      <tspan fill="#475569"> &#183; </tspan>
      <a href="https://princymaheshwari.me" target="_blank" rel="noopener noreferrer">
        <tspan fill="#f59e0b">portfolio</tspan>
      </a>
    </text>
    <rect x="165" y="28" width="7" height="14" fill="#10b981" opacity="0.8">
